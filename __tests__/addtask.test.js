...
const storeRetrieve = require('../modules/storeRetrieve')
...
describe('addtask', ()=>{
    test('Add one new task to the list when completed is false', () =>{
        ...
        const task = {description: 'new task', completed: false, index: 0, id: 123}
    ...
    test('Add one new task to the list when completed is true', () =>{
        ...
        const task = {description: 'new task 02', completed: true, index: 1, id: 456}
    ...
    test('Add one new task to localStorage', () =>{
        ...
        const task = {description: 'new task 03', completed: false, index: 2, id: 789}
